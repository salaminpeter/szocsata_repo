...
public:
	...
	CUIText(CUIElement* parent, std::shared_ptr<CSquarePositionData> positionData, std::shared_ptr<CSquareColorData> colorData, const wchar_t* text, int fontHeight, int x, int y, int vx, int vy, float r = .92f, float g = 0.92f, float b = .92f,  const wchar_t* id = L"");
