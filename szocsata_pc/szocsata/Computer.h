...
public:
	...
	void BackTrackWord(CWordFlatTree::TNode* node, std::wstring& word, int x, int y, bool horizontal, CBinaryBoolList usedLetters);
	void GetWordsInFieldList(const std::wstring& letters, CWordFlatTree::TNode* node, CBinaryBoolList usedLetters, std::vector<TField*>& fieldList, int wordStartIdx, int pos, bool horizontal, int charCount = 1);
